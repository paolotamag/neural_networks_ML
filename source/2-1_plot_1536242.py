...
c_index = [16, 66, 74, 25, 61,  9, 62, 69, 27, 52, 38, 32, 22, 24, 46, 68]
c = x_train[c_index,:]
...
plugged_in_var = np.array([-5.39163561,   3.81825606,  -7.61111776,   2.90520475,   3.90878747,
